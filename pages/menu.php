          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item" style=" margin-right: 35px; text-align: center;">
                <a class="nav-link" style="color: black; font-size: 20px; width: 200px;" href="pages/liste_apprenant.php">
              ...
              <li class="nav-item" style=" height: 60px; margin-right: 35px; text-align: center;">
                <a class="nav-link" style="color: black; font-size: 20px; width: 200px;" href="pages/liste_tuteur.php">
